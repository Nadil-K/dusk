...
<table>
  <thead>
    <tr>
      <th>Endpoint</th><th>Methods</th><th>Status</th>
      <th>Hits (30d)</th><th>Callers</th><th>Last seen</th>
    </tr>
  </thead>
  <tbody>
...
<style>
  ...
  th {
    text-align: left; padding: 0.6rem 1rem; border-bottom: 1px solid #313244;
    color: #a6adc8; font-weight: 600; font-size: 0.8rem;
